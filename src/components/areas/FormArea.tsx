...
export const FormArea: FC<Props> = ({ area, onSubmit }) => {
  ...
  return (
    <div className='bg-white py-5 px-8 border shadow rounded-md'>
      <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          className={`mt-8 flex items-center justify-center gap-2 bg-blue-600 text-white font-bold w-full rounded-md py-2 px-3 hover:bg-blue-700 transition-colors grayscale ${
